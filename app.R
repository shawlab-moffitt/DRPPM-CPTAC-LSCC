...
##--Large Project Files--##
#Meta
db_meta_file <- '~/R/DRPPM-EASY-LargeProject-main/CCLE_data/CCLE_meta.zip'
#Meta Selector File
db_meta_selec_file <- '~/R/DRPPM-EASY-LargeProject-main/CCLE_data/CCLE_meta_selector.tsv'
#Expression Data
db_expr_file <- '~/R/DRPPM-EASY-LargeProject-main/CCLE_data/CCLE_expr.zip'
#Name Map File
db_namemap_file <- '~/R/DRPPM-EASY-LargeProject-main/CCLE_data/CCLE_NameMap.tsv'
...
userGS_file <- '~/R/DRPPM-EASY-LargeProject-main/GeneSet_data/CellMarker_gsNsym_HS.tsv'
#Does gene set file have header?
header.gs <- TRUE
#path to your R data list object for ssGSEA
userRData_file <- '~/R/DRPPM-EASY-LargeProject-main/GeneSet_data/CellMarker_GS_HS.RData'
...
#MSigDB gene set
msigdb <- '~/R/DRPPM-EASY-LargeProject-main/GeneSet_data/msigdb_gsNsym_HS.zip'
#MSigDB gene set FOR UI
msigdb2 <- '~/R/DRPPM-EASY-LargeProject-main/GeneSet_data/msigdb_gsNcat_HS.tsv'
#gene set list for ssGSEA
load('~/R/DRPPM-EASY-LargeProject-main/GeneSet_data/msigdb_gs_HS.RData')
