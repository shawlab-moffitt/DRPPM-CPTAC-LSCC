...
userGS_file <- '~/R/DRPPM-EASY-LargeProject-main/CCLE-data/CellMarker_gsNsym_HS.tsv'
#Does gene set file have header?
header.gs <- TRUE
#path to your R data list object for ssGSEA
userRData_file <- '~/R/DRPPM-EASY-LargeProject-main/CCLE-data/CellMarker_GS_HS.RData'
...
#MSigDB gene set
msigdb <- '~/R/DRPPM-EASY-LargeProject-main/CCLE-data/msigdb_gsNsym_HS.zip'
#MSigDB gene set FOR UI
msigdb2 <- '~/R/DRPPM-EASY-LargeProject-main/CCLE-data/msigdb_gsNcat_HS.tsv'
#gene set list for ssGSEA
load('~/R/DRPPM-EASY-LargeProject-main/CCLE-data/msigdb_gs_HS.RData')
